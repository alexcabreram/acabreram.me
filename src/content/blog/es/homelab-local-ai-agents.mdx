...
Algunas cosas que quiero atacar pronto:

- **Cloudflare Tunnel** para poder acceder a servicios desde fuera sin abrir puertos
- **Agentes de marca personal** donde mando un mensaje de Telegram tipo "escribe algo sobre este artículo" y recibo un borrador de blog + post de LinkedIn
- **Wildcard HTTPS** con renovación automática de certificados vía Cloudflare DNS challenge
