...
Some things I want to tackle soon:

- **Cloudflare Tunnel** so I can access services from outside without opening ports
- **AI brand agents** where I send a Telegram message like "write something about this article" and get back a blog draft + LinkedIn post
